...
export function ActionRewardScreen() {
  const colors = useColors();
  const insets = useSafeAreaInsets();
  const { state, dismissActionReward } = useGame();
  ...
  if (!state.actionReward) return null;
    ...
    <View style={[styles.container, { backgroundColor: colors.navy }]}>
      ...
      >
        ...
        <PixelText size="lg" color={colors.parchment} bold align="center">
          Earned ${state.actionReward.earnings}!
        </PixelText>
        <PixelText size="sm" color={colors.tealLight} align="center">
          {state.actionReward.description}
        </PixelText>
