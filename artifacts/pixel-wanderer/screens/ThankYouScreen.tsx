...
export function ThankYouScreen() {
  ...
  const character = state.lastTalkedNpcIndex !== null && state.currentDestination
    ? state.currentDestination.people[state.lastTalkedNpcIndex]
    : null;
    ...
    <View style={[styles.container, { backgroundColor: colors.navy }]}>
      ...
      >
        ...
        <PixelText size="md" color={colors.tealLight} align="center">
          {character?.name || "The local"} appreciates your help.
        </PixelText>
